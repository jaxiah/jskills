...
When rewriting note content, use the `ankify` skill for card quality and note format. This skill controls locating, chat review, and scoped write-back.
